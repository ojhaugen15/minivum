...
function addLine (addAfter) {
 ...
 if (arentSame(addAfter, undefined)) {
  targetElement = getValue(body_node, addNumbers(addAfter, nonline_elements))
...
function executeCommand (keyPressed) {
 ...
 if (areSame(keyPressed, 't')) {
  editorSize = differenceNumbers(getValue(body_node, 'length'), nonline_elements)
...
function updateScroll () {
   newScroll = differenceNumbers(multiplyNumbers(newScroll, font_size), breathing_room)
